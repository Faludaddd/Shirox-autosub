...
FILES_TO_ADD = [
    ("Shirox/Services/AppUpdateManager.swift", "Services"),
    ("Shirox/Services/HistoryManager.swift", "Services"),
    ("Shirox/Views/Shared/UpdatePopupView.swift", "Shared"),
    ("Shirox/Views/Library/LibraryHistoryView.swift", "Library"),
]
